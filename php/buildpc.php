...
<body>
    ...
    <div id="body">
        <div class="navi_product">
            <p style="color: #2c2c2c; font-size: 44px; font-weight: 500; letter-spacing: 0.12em; margin-top: 96px; margin-bottom: 22px;">Compare</p>
            <p style="color: #2c2c2c; font-size: 16px; font-weight: 300; letter-spacing: 0.2em; margin-bottom: 80px;">HOME / COMPARE</p>
        </div>
