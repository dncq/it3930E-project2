        ...
        <div id="body" style="background-color: #2c3e50;">
            <a href="index.php">
                <div class="logo" style="width: 1512px; display: flex; align-items: center; margin: auto; padding-top: 30px;">
                    <img src="../assets/imgs/hust-pc.png" alt="" style="height: 120px; padding-left: 70px;">
                </div>
            </a>
                        ...
                        <div class="form1" style="width: 815px; border: 2px solid #fff; border-radius: 7px; margin-right: 14px; height: 648px;">
                            <div class="wrapper wrapper1" style="margin: auto; width: 736px;">
                                ...
                                <div class="level">
                                    <div>
                                        <p>First name *</p>
                                        <input type="text" name="first_name" placeholder="e.g. John" style="width: 343px;">
                                    </div>
                                    <div>
                                        <p>Last name *</p>
                                        <input type="text" name="last_name" placeholder="e.g. Smiths" style="width: 368px;">
                                    </div>
                                </div>
                                <div class="level">
                                    <div>
