...
<body>
    <div id="main">
            ...
            <div class="head-header" style="display: flex; width: 1440px; justify-content: space-between; margin: auto; padding-top: 20px;">
                ...
                <div class="header-function">
                    ...
                    <div class="header-support">
                        <a href="#">
                            <i class="fa-solid fa-headset" style="font-size: 36px;color: #ffc107"></i>
                            <div class="support-detail">
                                <h1 style="color: #ffc107">Sign in</h1>
                                <!-- <h3>Laptop Price</h3> -->
                            </div>
                        </a>
                    </div>
        ...
        <div id="footer" style="width: 100%; height: 366px; background-color: #2c3e50; position: relative; display: flex;">
            <div class="column1">
                <img src="../assets/imgs/hust-pc.png" alt="" class="footer-logo" style="width: 118px; position: absolute; top: 32px; left: 172px;">
