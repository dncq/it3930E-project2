            ...
            <div class="main__body">
                ...
                <div class="wrapper__form" style="width: 978px; margin: auto;">
                    <div class="level level1">
                        <div class="firtname">
                            <p>First name *</p>
                            <input type="text" placeholder="e.g. Dinh" style="width: 394px;">
                        </div>
                        <div class="lastname">
                            <p>Last name *</p>
                            <input type="text" placeholder="e.g. Quy" style="width: 478px;">
                        </div>
                    </div>
                    <div class="level level2">
                        <div class="phone-num">
                            <p>Phone number *</p>
                            <input type="text" placeholder="e.g. 0123456789" style="width: 294px;">
                        </div>
                        <div class="email">
                            <p>Email address *</p>
                            <input type="text" placeholder="e.g. abcxyz@gmail.com" style="width: 539px;">
                        </div>
                    </div>
