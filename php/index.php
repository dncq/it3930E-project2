...
<head>
    ...
    <title>Computers and IT Equipment</title>
    ...
    <div id="main">
        ...
        <div id="header" style="width: 100%; height: 211px; position: relative; background-color: #2c3e50;">
                ...
                <div class="header-function">
                    ...
                    <div class="header-support">
                        <a href="#">
                            ...
                            <div class="support-detail">
                                <!-- <h2>Sign in/</h2> -->
                                <h2> <?= $_SESSION['auth_user']['fullname'] ?></h2>
                                <!-- <h3>Laptop Price</h3> -->
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="header-support">
                        <a href="../php/signout.php">
                            ...
                            <div class="support-detail">
                                <!-- <h2>Sign in/</h2> -->
                                <h2 style="color: #ffc107">Sign Out</h2>
                                <!-- <h3>Laptop Price</h3> -->
                            </div>
                        </a>
                    </div>
            ...
            <ul class="nav" style="display: flex; list-style-type: none; position: absolute; bottom: 0; left: 50%; transform: translateX(-50%);">
                ...
                <li><a href="../php/buildpc.php">Compare</a></li>
        ...
        <div id="body1" style="width: 100%; background-color: #fff;">
            <div class="slide__level1" style="width: 1440px; margin: auto; display: flex; justify-content: space-between; padding-top: 20px;">
                ...
                <div class="slide__left">
                    ...
                    <div class="slide slide-1">
                        <img src="../assets/imgs/slider/acer_predator.jpg" alt="Slide 1">
                    </div>
                
                    <input id="slide-dot-2" type="radio" name="slides">
                    <div class="slide slide-2">
                        <img src="../assets/imgs/slider/legion_pro.jpg" alt="Slide 2">
                    </div>
                    ...
                    <div class="slide slide-4">
                        <img src="../assets/imgs/slider/asus_rog.jpg" alt="Slide 4">
                    </div>

                    <input id="slide-dot-5" type="radio" name="slides">
                    <div class="slide slide-5">
                        <img src="../assets/imgs/slider/msi_modem.jpg" alt="Slide 5">
                    </div>

                    <input id="slide-dot-6" type="radio" name="slides">
                    <div class="slide slide-6">
                        <img src="../assets/imgs/slider/dell_alienware.jpg" alt="Slide 6">
                    </div>
                </div>
            ...
            <div class="best-seller-container" style="width: 1440px; height: 170px; margin: auto; align-items: center; display: flex;">
                <div style="width: 1360px; display: flex; align-items: center; justify-content: space-between; margin: auto;">
                    <div class="brand1"><img src="../assets/imgs/brand_logo/asus.png" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/acer.jpg" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/dell.png" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/hp.png" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/lenovo.jpg" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/razer.png" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/msi-logo.jpg" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/gigabyte.jpg" alt=""></div>
                    <div class="brand1"><img src="../assets/imgs/brand_logo/microsoft.png" alt=""></div>
                </div>
            </div>
